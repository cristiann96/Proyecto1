...
<html lang="es">
	<head>
		...
		<title>Iniciar sesión o Nuevo registro</title>
		<meta name="description" content="Iniciar sesión o Crear un Nuevo registro" />
	...
	<body class=" customer-account-login floating-header onlyhome-slider boxed-layout hover-scale popup-mobile popup-tablet sticky-mobile sticky-tablet none sidebar-left">
							...
							<div class="row clearfix">
								...
								<nav class="nav-container">
									<ul class="nav-wide" id="nav-wide">
										...
										<li class="level0 nav-1 first level-top"><a href="bicis_robadas.php" class="level-top"><span>Bicis Robadas</span></a></li>
									</ul>
								</nav>
					...
					<div class="row clearfix">
						<div class="grid_12 col-main">
							<div class="account-login">
								...
								<form action="https://www.bikingpoint.es/customer/account/loginPost/" method="post" id="login-form">
									<input name="form_key" type="hidden" value="z7KFszcGxx6Gq2Hs" />
									<div class="grid_6 alpha new-users">
										...
										<div class="buttons-set">
											<button type="button" title="Crear una cuenta" class="button" onclick="window.location='formregistro.html';"><span><span>Crear una cuenta</span></span></button>
										</div>
									</div>
									<div class="grid_6 omega registered-users">
										...
										<div class="buttons-set">
											...
											<a href="https://www.bikingpoint.es/customer/account/forgotpassword/" class="f-left">Olvidó su contraseña?</a>
										</div>
									</div>
									<div class="clear"></div>
								</form>
